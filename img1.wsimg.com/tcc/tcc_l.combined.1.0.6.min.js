! function(a, b) {
    var c = function(a) {
        ...
        function h(a, b) {
            ...
            for (var d = 0; d < a; d++) c += b.charAt(Math.floor(Math.random() * b.length));
            return c
        }

        function i(a) {
            for (var b = 0, c = 0, d = a.length; c < d; c++) b = 31 * b + a.charCodeAt(c) << 0;
            return b = Math.abs(b), b.toString(16)
        }
        return a || (a = {}), a.debugMode ? {
            hashString: i,
            getFirstSegment: c,
            generateGuid: b,
            hashCode: i
    ...
    var d = function(a) {
        function b() {
            return Date.prototype.toISOString || function() {
                ...
                Date.prototype.toISOString = function() {
                    ...
                    return b += "-" + a(this.getUTCDate()) + "T" + a(this.getUTCHours()) + ":", b += a(this.getUTCMinutes()) + ":" + a(this.getUTCSeconds()) + ".", b += String((this.getUTCMilliseconds() / 1e3).toFixed(3)).slice(2, 5) + "Z"
                }
        ...
        function c(a, b) {
            ...
            else if (1 === c) throw new Error("Warning: rand() expects exactly 2 parameters, 1 given");
            return Math.floor(Math.random() * (b - a + 1)) + a
        }

        function d(a, b) {
            var c = w;
            return c.queryString = e(a, "tccl."), c.host = b, c.toString().length > 2048 && (c.queryString = c.queryString.substring(0, 2047 - c.host.length)), c
        }
        ...
        function i() {
            this.properties = {}, this.id = "", this.properties.cts = (new Date).getTime(), this.get = function(a) {
        ...
        function l(b) {
            return b || (b = a.window.location.pathname), "string" != typeof b || void 0 === b || "" === b ? "notspecified" : (b.lastIndexOf("/") === b.length - 1 && (b = b.substring(0, b.length - 1)), 0 !== b.indexOf("/") && (b = "/" + b), b)
        }
        ...
        function q(a, b, c, d, e, f, g) {
            ...
            var i = b + "=" + encodeURI(c) + (d ? "; expires=" + h.toGMTString() : "") + (d ? "; max-age=" + 60 * d : "") + (e ? "; path=" + e : "") + (f ? "; domain=" + f : "") + (g ? "; secure" : "");
            a.cookie = i
        }
        ...
        function u(a, b) {
            ...
            return void 0 !== b.cookieEnabled || c || (q(a, "testcookie"), c = a.cookie.indexOf("testcookie") !== -1), c
        }

        function v(a) {
            if ("object" == typeof a && p(a)) {
                for (var b = "", c = 0; c < a.length; c++) c > 0 && (b += "^"), p(a[c]) && (b += a[c][0] + "," + a[c][1]);
                if ("" !== b) return b
            }
        } // eslint-disable-line no-unused-vars
        a || (a = {}), a.window || (a.window = window), a.doc || (a.doc = document), a.debugMode || (a.debugMode = !1);
        var w = {
            host: "",
            queryString: "",
            toString: function() {
    ...
    if (!e) var e = function(a) {
        ...
        a || (a = {}), a.window || (a.window = window), a.debugMode || (a.debugMode = !1), a.document || (a.document = document), a.delay || (a.delay = 200), a.maxDelay || (a.maxDelay = 7e3), a.perfSent = !1;
        var e = {};
        ...
        return void 0 === a.createEvent && (a.createEvent = !0), a.performance || (a.window && a.window.performance ? a.performance = a.window.performance : d("Error loading performance lib")), void 0 !== a.document.readyState && "complete" === a.document.readyState ? setTimeout(b, a.delay) : a.createEvent && (a.document && a.document.addEventListener ? a.window.addEventListener("load", function() {
            setTimeout(b, a.delay)
        }) : a.document && a.document.attachEvent && a.document.attachEvent("onreadystatechange", function() {
            "complete" === document.readyState && setTimeout(b, a.delay)
        })), setTimeout(function() {
            a.perfSent || b()
        }, a.maxDelay), a.debugMode, {
    ...
    void 0 !== b && (
        //node testability hack
        b.tcp = e);
    ! function(a) { // eslint-disable-line no-unused-vars
        a || (a = {}), a.debugMode = a.debugMode || !1, a.window = a.window || window, a.doc = a.doc || document, a.utility = a.utility || d, // eslint-disable-line no-undef
            ...
            a.baseHost = "test-secureserver.net", a.tcnPath = "/t/1/tl/event", a.version = "1.0.6", a.trfdData = [];
        var b = function(a) {
                function b(b) {
                ...
                function c(b, c, d, f) {
                    var g = new a.utility.eventObject,
                        h = "pageview";
                    g.set("ht", h), g.set("eid", c), b && g.set("dp", b), d && g.set("usrin", a.utility.usrinToString(d)), f && g.merge(f), e(g, h, function() {})
                }

                function d(b, c, d, f) {
                    var g = new a.utility.eventObject,
                        h = "pageevent";
                    g.set("ht", h), g.set("ea", b), g.set("eid", c), d && g.set("usrin", a.utility.usrinToString(d)), f && g.merge(f),
                ...
                function g() {
                    ...
                    // create cookie or reset the expiration time
                    return b || c ? (b || (b = a.guid.generateGuid()), c || (c = a.guid.generateGuid())) : b = c = a.guid.generateGuid(), a.utility.setCookie(a.doc, "_tccl_visitor", b, 525600, "/", null), a.utility.setCookie(a.doc, "_tccl_visit", c, 30, "/", null), {
                        visitor: b,
                        visit: c
                    }
                }
            ...
            f = function() {
                ...
                this.push = function(c, d) {
                    ...
                    var e = Array.prototype.slice.call(c, 1),
                        f = c[0];
                    b("tracker queue object name %s", h), b("tracker queue object method name %s", f), a.window[h][f] && a.window[h][f].apply(a.window[h], e), d && "function" == typeof d && d()
        ...
        a.utility.isArray(j) &&
            ...
            i.loadCommands(j), window._trfq = i, window._trfq.process()
    }();
    b.true = a
}({}, function() {
    return this
