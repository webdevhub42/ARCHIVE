...
export default function Button({
    ...
    const iconAdjustStyles = styleProps.fill !== 'OPEN' ? {
    ...
    const iconChildren = ( <
        ...
        UX2.Element.Element style = {
            ...
            typeof icon === 'string' ? < UX2.Element.Icon icon = {
                icon
            }
            size = {
        ...
        return this.merge({
            ...
            ...externalLinkProps,
            children: icon ? iconChildren : < React.Fragment > {
                btnAddonEl
            } {
                children
            } < /React.Fragment>, ['data-ux-btn']: this.base.kind.toLowerCase()
        }, styleProps, props);
    }