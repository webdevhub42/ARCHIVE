...
export default function styles({
    ...
    const {
        state = 'default', shape, fill, decoration, shadow, color, customBorderWidth = 'xsmall', ...otherProps
    } = props;
    ...
    return this.merge({},
        ...
        ...[sizes, handleShape, handleFill, handleDecoration, handleShadow].map(trait => trait.call(this, { ...otherProps,
            ...buttonProps
        }))
    );
}