...
export const resolveFontSizeCharCount = ({
    ...
    const ranges = reduce(fontSizeMap, (array, [min, max = Number.MAX_VALUE], fontSize) => {
        array.push({
            range: [min, max],
            fontSize
        });
...
export const resolveForCharCount = ({
    ...
    return Object.keys(valueMap)
        .reduce((resolvedValue, key) =>
            resolvedValue || inRange(count, valueMap[key][0], valueMap[key][1] || maxCharCount) && key,
            false) || defaultValue;
};
