...
class Default extends UX2.Theme {
        ...
        this.mappedValues = {
            ...
            typography: value => {
                return (props = {}) => {
                    ...
                    const fullPath = typographyBaseType !== value ? mergeTypographyOverrides.call(this, value, props) : {};
                    return merge({}, resolveValue.call(this, typographyBase, props) || {}, stateStyles, fullPath);
                };
            }
        };
    }
    ...
    getButtonDefaults() {
        ...
        const buttonDefaults = omit((this.constructor.config && this.constructor.config.buttons[buttonType]) || {}, INVALID_BUTTON_DEFAULTS[buttonType]);
        return merge({}, primaryDefaults, buttonDefaults);
    }

    // Returns a list of all supported typographies for this theme
    getTypographyList() {
        return uniq(Object.keys(this.mappedValues.typographyMapping)
                .concat(Object.keys(this.mappedValues.typographyOverrides || {})))
    ...
    BackgroundResponsive() {
        return Components.BackgroundResponsive.apply(this, arguments);
    }
    ...
    ImageResponsive() {
        return Elements.ImageResponsive.apply(this, arguments);
    }
