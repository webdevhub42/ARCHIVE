...
export default class ContentText extends Component {
    ...
    getPlainCaption(caption) {
        ...
        if (textBlocks.length > 1) {
            ...
            textBlocks.forEach(item => item.text === '' ? captionTextArray.push('\n\n') : captionTextArray.push(item.text));
    ...
    renderCollapsedText(textProps) {
        ...
        const {
            collapseThreshold = DEFAULT_COLLAPSE_THRESHOLD,
                ...
                expandIconProps = {}, collapseIconProps = {}, renderMode
        } = textCollapseProps;
        ...
        const shouldCollapseCaption =
            (parsedCaption ? this.getPlainCaption(parsedCaption).length : children.length) > (collapseThreshold + collapseMinOverflow);
        ...
        render() {
            ...
            return children ? (
                textCollapseProps.enabled ? this.renderCollapsedText(textProps) : < UX2.Element.Text alignment = {
                    alignment
                } { ...omit(textProps, 'textCollapseProps')
                }
                />
