...
function borderColorInput() {
    ...
    return outline ?
        utils.getBackgroundColor(this, 'input').contrastWith(background, 10 * utils.getDial(this, 'multiplier'), true) :
...
function borderColorInputError() {
    const [error, background, multiplier] = utils.getDial(this, ['error', 'background', 'multiplier']);
