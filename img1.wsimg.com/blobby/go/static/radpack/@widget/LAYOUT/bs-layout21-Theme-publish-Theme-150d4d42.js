define("@widget/LAYOUT/bs-layout21-Theme-publish-Theme-150d4d42.js", ["exports", "@widget/LAYOUT/c/bs-_rollupPluginBabelHelpers", "@widget/LAYOUT/c/bs-index3", "@widget/LAYOUT/c/bs-legacyOverrides", "@widget/LAYOUT/c/bs-modernThinRound", "@widget/LAYOUT/c/bs-defaultSocialIconPack", "@widget/LAYOUT/c/bs-loaders", "@widget/LAYOUT/c/bs-index"], (function(e, t, r, n, o, a, s, i) {
    "use strict";
    const {
        colorPackCategories: l,
        buttons: g
    ...
    const T = ["about1", "content4", "introduction4", "payment1", "payment2", "membership1"],
        {
            hasFontSet: x
        } = r.f,
        {
    ...
    class A extends r.D {
        ...
        constructor() {
            super(), this.mappedValues = { ...this.mappedValues,
                borderColorHighlight: () => {
                    const [e, t, n, o] = r.g(this, ["background", "primary", "neutral", "accent"]);
                    return ((e, t) => {
                        const n = e.filter((({
                            precheck: e
                        }) => e));
        ...
        Section({
            ...
            const {
                ...
                "@xs-only": {
                    paddingVertical: "FOOTER" === this.base.widgetType ? "none" : "large"
                }
            };
            let a = this.merge({
                style: o,
            ...
            return "FOOTER" === n && "neutral" === r && (a = this.merge({
                style: o,
        ...
        Hero(e) {
            const t = (global._ || guac.lodash).omit(e.style, ["> :nth-child(n)", " > :last-child"]);
            return super.Hero(Object.assign(e, {
                style: t
            }))
        }
        Tagline({
        ...
        SectionHeading(e) {
            const t = {
                style: {
                    textAlign: "payment2" === this.base.widgetPreset ? "center" : "left"
                }
            };
        ...
        ContentBasic(e) {
            const t = -1 === T.indexOf(this.base.widgetPreset) ? {
                alignment: "left"
            } : {};
        ...
        ContentCard(e) {
            const {
                widgetPreset: t
            } = this.base, r = -1 === T.indexOf(t) ? {
                alignment: "left"
            } : {}, n = "about1" === this.base.widgetPreset ? {
                style: {
                    alignItems: "center"
                }
            } : {};
        ...
        FeaturedText(e) {
            return super.FeaturedText(this.merge({
                style: {
                    fontStyle: x(this.base.fonts, "old-standard-tt") ? "italic" : "normal !important"
                },
                typography: "BodyBeta"
            }, e))
        }
        ...
        IconSearch(e) {
            return super.IconSearch(this.merge({
                style: {
                    color: "action"
                }
            }, e))
        ...
        Button(e) {
            ...
            } = e, o = t && t === C.EDIT, a = r !== w.fills.OPEN ? {
                style: {
                    transition: "all 0.3s"
                }
            } : {}, s = r === w.fills.SOLID && n === w.shadows.NONE ? {
                style: { ...!o && {
                        ":hover": {
                            "@md": {
        ...
        Heading(e) {
            const {
                ...
                widgetType: r,
                widgetPreset: o
            } = this.base, a = "FOOTER" === this.base.widgetType ? {
                level: "5",
                style: {
                    fontSize: "14px"
                }
            } : null;
            return super.Heading(this.merge(a, {
                style: n.g(t, r, o)
            }, e))
        }
        WrapperImage(e) {
            return super.WrapperImage(this.merge({
                style: {
                    height: "100%"
                }
            }, e))
        ...
        NavMoreMenuLinkActive(e) {
            return super.NavMoreMenuLinkActive(this.merge({
                style: {
                    borderTop: 0,
                    paddingTop: 0
                }
        ...
        ContactBarAddress(e) {
            return super.ContactBarAddress(this.merge({
                style: {
                    "@xs-only": {
                        fontSize: "small"
                    }
    ...
    t._(A, "config", f), t._(A, "excludedProps", (global._ || guac.lodash).without(r.D.excludedProps, "address").concat("tagline2")), e.default = A
