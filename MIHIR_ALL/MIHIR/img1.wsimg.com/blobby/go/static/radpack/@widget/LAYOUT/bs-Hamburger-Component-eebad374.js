define(
  "@widget/LAYOUT/bs-Hamburger-Component-eebad374.js",
  [
    "exports",
    "@widget/LAYOUT/c/bs-_rollupPluginBabelHelpers",
    "@widget/LAYOUT/c/bs-Toggle",
    "@widget/LAYOUT/c/bs-dataAids",
    "@widget/LAYOUT/c/bs-index",
  ],
  function (e, t, o, n, r) {
    "use strict";
    const { renderModes: a } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants,
      s = (e) => {
        ...
        const t = ((e) =>
          (e === a.PREVIEW &&
            (document.querySelector(
              ".mobile-phone-preview-container .viewport"
            ) ||
              document.querySelector("#render-container"))) ||
          document.querySelector("body"))(e);
        if (!t) return "100vh";
        const o = document.querySelector(
          ".mobile-phone-preview-container .ux-scaled"
        );
        let n = 1;
        if (o) {
          const e = (global._ || guac.lodash)
            .get(o, "style.transform", "")
            .match(/[0-9.]+/);
          e && e.length > 0 && (n = e[0]);
        }
    ...
    class i extends (global.React || guac.react).Component {
      ...
      componentDidUpdate(e, { open: t }) {
        const { openWidth: o, isMobile: n, renderMode: r } = this.props;
        if (t !== this.state.open) {
          ...
          t &&
            ((t.style.maxWidth = this.state.open ? o : 0),
            (t.style.boxShadow = this.state.open
              ? "0 2px 6px 0px rgba(0,0,0,0.2)"
              : ""),
            n &&
              ((t.style.height = `${s(r)}px`),
      ...
      toggleScrolling(e) {
        const { renderMode: t } = this.props,
          o = ((e) =>
            (e === a.PREVIEW &&
              (document.querySelector(
                ".mobile-phone-preview-container #render-container"
              ) ||
                document.querySelector("#render-container"))) ||
            document.querySelector("body"))(t);
        if (
          t ===
          (global.Core || guac["@wsb/guac-widget-core"]).constants.renderModes
            .PUBLISH
        ) {
          const { uniqueId: t } = this.props,
            o = document.getElementById(`${t}-navId-mobile`);
          e
            ? (o.addEventListener("touchstart", this.handleTouchStart),
              o.addEventListener("touchmove", this.handleTouchMove))
            : (o.removeEventListener("touchstart", this.handleTouchStart),
              o.removeEventListener("touchmove", this.handleTouchMove));
        } else
          o.style.setProperty("overflow-y", e ? "hidden" : "auto", "important");
      }
      handleTouchStart(e) {
        const t = e.touches[0],
          { clientY: o } = t;
      ...
      handleTouchMove(e) {
        const { uniqueId: t } = this.props,
          o = document.getElementById(`${t}-navContainerId-mobile`),
          n = document.getElementById(`${t}-navLinksContentId-mobile`),
          r = o.getBoundingClientRect().bottom,
          { bottom: a } = n.getBoundingClientRect(),
          { scrollTop: s } = o,
          i = e.touches[0],
          { clientY: l } = i;
        (l < this.startY && a <= r) || (l >= this.startY && s <= 0)
          ? e.preventDefault()
          : e.stopPropagation();
      }
      handleChange(e) {
