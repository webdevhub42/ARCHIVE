  ...
  return this.merge(
    {
      ...
      children: (
        <React.Fragment>
          ...
          <UX.Style> {keyframes.loaderRipple} </UX.Style>{" "}
        </React.Fragment>
      ),
      style: {
        "> svg": {
  ...
  return this.merge(
    {
      ...
      children: (
        <React.Fragment>
          ...
          <UX.Style> {keyframes.loaderCascade} </UX.Style>{" "}
        </React.Fragment>
      ),
      style: {
        "> svg circle": {
  ...
  return this.merge(
    {
      ...
      children: (
        <React.Fragment>
          ...
          <UX.Style> {keyframes.loaderBlink} </UX.Style>{" "}
        </React.Fragment>
      ),
      style: {
        "> svg circle": {
          animation:
            "blink 2s infinite alternate cubic-bezier(.64,.21,.39,.9);",
        },
      },
    },
    props
