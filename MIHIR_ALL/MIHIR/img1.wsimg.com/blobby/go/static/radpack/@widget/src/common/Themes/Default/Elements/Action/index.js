...
export function Link({
    ...
    if (this.base.widgetType !== 'HEADER' &&
        href && isLink(href) &&
        children && typeof children !== 'string' &&
        !Array.isArray(children) && children.props &&
        children.props.icon) {
        const {
            props: childrenProps
        } = children;
    ...
    const omittedProps = ['renderMode', 'domainName', 'pageRoute', 'isAnchor', 'convertToAbsolute', 'activeStyle', 'item'];
...
export function LinkArrow({
    ...
    console.warn(`LinkArrow is deprecated. Use MoreLinkBackward or MoreLinkBackward. The issue is probably in ${this.base.widgetPreset}`);
    if (left === true) {
...
export function CarouselButtonPrevious(props) {
    ...
    }, commonArrowProps, carouselButtonProps, props));
}
...
export function InputCheckbox({
    ...
    const styles = {
        ...
        input: {
            ...
            ':checked ~ div:after': { // checkmark styles
                content: "''",
                display: 'block',
                top: '3px',
                left: '7px',
...
export function LinkIcon({
    ...
    const modifiedChildren = children ? [ < UX2.Element.Element key = 'span'
        style = {
            {
    ...
    export function MoreLink({
        ...
        if (icon) {
            return this.LinkIcon(this.merge({
                icon,
                right,
                rotate,
                iconSize,
